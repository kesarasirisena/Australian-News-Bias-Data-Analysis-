...
url = 'https://web.archive.org/cdx/search/cdx?url=https://theconversation.com/au/&collapse=digest&from=20210905&to=20211009&output=json'
#Get All URLS
...
for i in range(0,len(final_url)): 
    ...
    titles.append(soup[i].findAll("h2"))
    for title in titles:
...
with open('conversation.csv', 'a') as csvfile:   
