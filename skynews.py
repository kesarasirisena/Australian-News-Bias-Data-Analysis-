...
url = 'https://web.archive.org/cdx/search/cdx?url=https://www.skynews.com.au/&collapse=digest&from=20210904&to=20211009&output=json'
#Get All URLS
...
for i in range(0,len(final_url)): 
    ...
    titles.append(soup[i].findAll("h4"))
    for title in titles:
...
with open('sky.csv', 'a') as csvfile:   
